...
class OrderViewModel : ViewModel() {
    ...
    fun setAccompaniment(accompaniment: String) {
        ...
        previousEntreePrice = _accompaniment.value?.price ?: 0.0
    ...
    private fun updateSubtotal(itemPrice: Double) {
        // TODOok: if _subtotal.value is not null, update it to reflect the price of the recently
        //  added item.
        ...
        if(_subtotal.value !=null){
            ...
            // TODOok: calculate the tax and resulting total
    ...
    fun calculateTaxAndTotal() {
        // TODOok: set _tax.value based on the subtotal and the tax rate.
        _tax.value = _subtotal.value?.times(taxRate)

        // TODOok: set the total based on the subtotal and _tax.value.
